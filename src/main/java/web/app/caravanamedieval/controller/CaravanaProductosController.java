...
public class CaravanaProductosController{
    ...
    public ModelAndView editCaravanaProductosFormulario(@PathVariable Long idCaravana){
      CaravanaProductosDTO caravanaProductosDTO = caravanaService.getCaravanaProductos(idCaravana).orElseThrow();
    ...
    @PostMapping("/save")
    public RedirectView saveCaravanaProductos(@ModelAttribute CaravanaProductosDTO cpd){
